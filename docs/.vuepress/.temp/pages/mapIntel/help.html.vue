...
<blockquote>
<p>请先确保现有文档等资料无法解决你的问题</p>
</blockquote>
</li>
</ul>
<h2 id="梳理问题" tabindex="-1"><a class="header-anchor" href="#梳理问题" aria-hidden="true">#</a> 梳理问题</h2>
<p>为了让更快速理解你的问题及解决您的问题，强烈建议一次性梳理说明清楚您的需求或问题、整理可复现问题的最简代码 再进行沟通。</p>
<h3 id="_1-如果是提问题或需求-请组织语言一次性描述清楚" tabindex="-1"><a class="header-anchor" href="#_1-如果是提问题或需求-请组织语言一次性描述清楚" aria-hidden="true">#</a> 1. 如果是提问题或需求: 请组织语言一次性描述清楚</h3>
<p>1.<strong>期望的结果是什么</strong>？ 尽可能将您的想实现的需求描述完整。</p>
<p>2.<strong>现状是什么</strong>? 当前是如何操作或编写代码的?</p>
<ul>
<li>(1) 描述清楚问题或操作的 所在场景及步骤，尽可能的让我们可以复现。</li>
<li>(2) 附上当前<strong>F12 的错误提示/js 代码截图/页面运行效果</strong>的完整截图（复杂的可手机拍下视频）</li>
</ul>
<h3 id="_2-如果是调试代码-请整理一个最简可复现的代码" tabindex="-1"><a class="header-anchor" href="#_2-如果是调试代码-请整理一个最简可复现的代码" aria-hidden="true">#</a> 2. 如果是调试代码：请整理一个最简可复现的代码</h3>
<p>如果问题比较复杂或者我们测试人员很难重现，那么建议您整理下代码，发送重现问题的最简单代码包给我们开发人员帮忙排查，这将使得他人更方便地复现你的问题。</p>
<p>1.<strong>Mars2D 的类及方法使用相关问题</strong>：请整理代码，在或开源的项目模版中参考已有示例页面和代码，创建一个重现问题的代码发我们。</p>
<p>2.<strong>Vue 或者其他环境集成相关问题</strong>：请创建一个干净并可复现问题的工程，一起打包（注意：<code v-pre>node_modules</code>目录不要一起打包进去）后发我们。</p>
<p>如果依赖后端服务，请提供在线服务地址或离线的 mock 数据。</p>
<blockquote>
<p>例子应尽可能以最简单的方式复现你的问题，去除不必要的配置项和数据，可以让帮助你的人更快速地定位问题，从而让你的问题更快得到解决。</p>
</blockquote>
<h2 id="个人对个人悬赏服务-红包打赏处理问题人员-单个问题的解决" tabindex="-1"><a class="header-anchor" href="#个人对个人悬赏服务-红包打赏处理问题人员-单个问题的解决" aria-hidden="true">#</a> 个人对个人悬赏服务：红包打赏处理问题人员(单个问题的解决)</h2>
<p>有些问题或需求需要花费解决问题人员大量时间，如果您想节省自身时间，让群友给您快速、开心的解决问题，建议您通过发红包方式悬赏解决单个问题，并且这是一种双赢的选择。</p>
<ul>
...
<li>无合同发票，红包打赏前请确认身份、并沟通清楚问题，被骗我司概不负责</li>
<li>我司也允许公司运维人员参与解决悬赏问题，对应金额直接转给运维人员</li>
</ul>
<h2 id="公对公付费服务-1v1-按月-vip-付费服务" tabindex="-1"><a class="header-anchor" href="#公对公付费服务-1v1-按月-vip-付费服务" aria-hidden="true">#</a> 公对公付费服务：1v1 按月 VIP 付费服务</h2>
<p>在免费公开群为大家提供服务时，我们是争取最大可能的做到：<strong>所有问题有问必回、有始有终。</strong>
但也可能一些因素，比如：<br /></p>
<ul>
<li>我们运维人员处理的问题过多，时间和精力有限，无法完美详细的处理好所有问题。</li>
<li>单位情况特殊，涉密数据、代码比较多，不方便公开渠道讨论</li>
<li>您的技术人员经验不够、比较多</li>
<li>项目时间紧、问题比较紧急</li>
<li>熟悉 Mars2D 的员工已离职，新入职的员工处于懵逼状态</li>
</ul>
<p>您也可以考虑购买火星科技官方提供的更高效、更私密的<a href="http://mall.marsgis.cn/#/product/service-monthly" target="_blank" rel="noopener noreferrer">VIP 付费指导服务(1V1)<ExternalLinkIcon/></a>, 我们会建议一对一的私密指导群，该群内只有双方单位人员组成，最优先响应、处理贵单位相关问题。具体可以联系<a href="http://mars2d.cn/contact.html" target="_blank" rel="noopener noreferrer">我们<ExternalLinkIcon/></a>咨询。</p>
<blockquote>
<p>这是公司对公司行为，提供合同发票，需公对公转账。</p>
</blockquote>
</div></template>
