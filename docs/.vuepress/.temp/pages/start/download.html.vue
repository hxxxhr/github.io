...
<h3 id="_2-1-可以选用-unpkg-com的cdn服务" tabindex="-1"><a class="header-anchor" href="#_2-1-可以选用-unpkg-com的cdn服务" aria-hidden="true">#</a> 2.1 可以选用<a href="https://unpkg.com/" target="_blank" rel="noopener noreferrer"> unpkg.com<ExternalLinkIcon/></a>的CDN服务</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-可以选用jsdelivr的cdn服务" tabindex="-1"><a class="header-anchor" href="#_2-2-可以选用jsdelivr的cdn服务" aria-hidden="true">#</a> 2.2 可以选用<a href="https://www.jsdelivr.com/package/npm/mars2d" target="_blank" rel="noopener noreferrer">jsDelivr<ExternalLinkIcon/></a>的CDN服务</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span>引入leaflet基础lib<span class="token operator">--</span><span class="token operator">></span>
<span class="token operator">&lt;</span>link rel<span class="token operator">=</span><span class="token string">"stylesheet"</span> href<span class="token operator">=</span><span class="token string">"https://unpkg.com/leaflet/dist/leaflet.css"</span> <span class="token operator">/</span><span class="token operator">></span>
<span class="token operator">&lt;</span>script src<span class="token operator">=</span><span class="token string">"https://unpkg.com/leaflet/dist/leaflet.js"</span> crossorigin<span class="token operator">=</span><span class="token string">""</span><span class="token operator">></span><span class="token operator">&lt;</span><span class="token operator">/</span>script<span class="token operator">></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-可以选用mars2d官网的cdn服务" tabindex="-1"><a class="header-anchor" href="#_2-3-可以选用mars2d官网的cdn服务" aria-hidden="true">#</a> 2.3 可以选用Mars2D官网的CDN服务</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span>引入leaflet基础lib<span class="token operator">--</span><span class="token operator">></span>
...
<h3 id="_3-1-类似cdn的head静态资源方式引入" tabindex="-1"><a class="header-anchor" href="#_3-1-类似cdn的head静态资源方式引入" aria-hidden="true">#</a> 3.1 类似CDN的head静态资源方式引入</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span>引入leaflet基础lib<span class="token operator">--</span><span class="token operator">></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-类似npm的import方式导入" tabindex="-1"><a class="header-anchor" href="#_3-2-类似npm的import方式导入" aria-hidden="true">#</a> 3.2 类似npm的import方式导入</h3>
<p>方式 1：需改动源码<br />
