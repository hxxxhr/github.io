...
<h2 id="_2-sdk-类库介绍" tabindex="-1"><a class="header-anchor" href="#_2-sdk-类库介绍" aria-hidden="true">#</a> 2. SDK 类库介绍</h2>
<p>Mars2D 平台开发的 SDK 所有类及方法均以 mars2d 开头命名，<code v-pre>mars2d.*</code> 为平台框架的默认命名空间，所有用到的类及方法都是通过<code v-pre>mars2d.*</code>来调用。 开发时尽量不要使用 <code v-pre>mars2d</code> 来定义自己的变量或类名、方法名，避免框架无法正常使用。</p>
<h3 id="_3-1-sdk主类库" tabindex="-1"><a class="header-anchor" href="#_3-1-sdk主类库" aria-hidden="true">#</a> 3.1 SDK主类库</h3>
<table>
<thead>
<tr>
<th style="text-align:center">包名</th>
<th style="text-align:center">当前版本</th>
<th style="text-align:center">CDN地址</th>
...
<td style="text-align:center"></td>
<td style="text-align:center">Mars2D主类库</td>
</tr>
</tbody>
</table>
<h3 id="_3-2-sdk插件库-可选" tabindex="-1"><a class="header-anchor" href="#_3-2-sdk插件库-可选" aria-hidden="true">#</a> 3.2 SDK插件库（可选）</h3>
<p>部分插件没有合并在主库中，方便不同场景下按需使用</p>
<table>
<thead>
<tr>
<th style="text-align:center">包名</th>
...
<td style="text-align:center"></td>
<td style="text-align:center">echarts可视化插件</td>
</tr>
<tr>
...
<td style="text-align:center"></td>
<td style="text-align:center">mapv可视化插件</td>
</tr>
<tr>
...
<td style="text-align:center"></td>
<td style="text-align:center">esri服务插件</td>
</tr>
<tr>
...
<td style="text-align:center"></td>
<td style="text-align:center">原生js下的widget模块化插件</td>
</tr>
</tbody>
</table>
<h3 id="_3-3-sdk的架构" tabindex="-1"><a class="header-anchor" href="#_3-3-sdk的架构" aria-hidden="true">#</a> 3.3 SDK的架构</h3>
<p>少数包放在二级包下，清单如下：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>mars2d<span class="token punctuation">.</span>layer<span class="token punctuation">.</span><span class="token operator">*</span>      <span class="token comment">//图层,比如 mars2d.layer.GraphicLayer</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其他类都在mars2d一级包下面</p>
...
<p>见<a href="">基础项目Vue版介绍</a>章节介绍。</p>
</div></template>
